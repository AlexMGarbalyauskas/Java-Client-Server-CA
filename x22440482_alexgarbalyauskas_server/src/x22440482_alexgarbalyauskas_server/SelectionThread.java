    ...
    public void run() {
        try {
            ...
            // User selects calendar opens calendar thread
                ...
                // Initializes the calendar thread 
        ...
        // General Errors
            ...
            System.err.println("I/O error occurred in selection Thread: " + e.getMessage());
        } catch (Exception e) {
            System.err.println("An unexpected error occurred in selection Thread: " + e.getMessage());
        }
    } // run end 
}